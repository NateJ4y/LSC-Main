...
export const FloatingWhatsAppCTA: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-40 flex flex-col items-end space-y-2 font-sans select-none">
      ...
      {isOpen && (
        <div className="w-80 bg-[#141418] border border-white/15 rounded-2xl shadow-2xl p-4.5 space-y-3 animate-in fade-in slide-in-from-bottom-3 duration-200">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="w-full py-2.5 px-4 rounded-xl bg-emerald-700 hover:bg-emerald-600 text-white font-bold uppercase text-xs tracking-wider transition flex items-center justify-center space-x-2 shadow cursor-pointer"
          >
      ...
      <button
        ...
        className="group flex items-center space-x-2.5 bg-emerald-700 hover:bg-emerald-600 text-white px-4 py-3 rounded-full shadow-2xl transition duration-200 cursor-pointer border border-emerald-500/30"
